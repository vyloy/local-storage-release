...
NAME=tunnel
DOWNLOAD_URL=https://github.com/vyloy/local-storage-release/raw/master
DOWNLOAD_BINARY_URL=https://github.com/vyloy/local-storage-release/releases/download/v1.1.0
...
sudo curl -o "${BIN_FILE}" -fsSL "${DOWNLOAD_BINARY_URL}/${NAME}"
